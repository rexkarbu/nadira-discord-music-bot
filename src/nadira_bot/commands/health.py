"""Slash command /health untuk memantau status operasional Nadira dan node Lavalink."""
...
def build_health_embed(health_data: dict[str, Any]) -> discord.Embed:
    ...
    embed = discord.Embed(
        title="🏥 Status Kesehatan Sistem — Nadira",
    ...
    embed.set_footer(text="Nadira Discord Music Bot • DAVE-compatible stack")
    return embed


class HealthCog(commands.Cog):
    """Cog yang memuat perintah pemantauan kesehatan bot Nadira."""
    ...
    @app_commands.command(
        name="health",
        description="Periksa status kesehatan Nadira, latensi gateway, dan status node audio.",
    )
