"""Slash commands /join dan /stop serta event listener voice state Nadira."""
...
from nadira_bot.presentation.interactions import respond_or_edit
...
class VoiceCog(commands.Cog):
    ...
    def __init__(self, bot: "NadiraBot") -> None:
        self.bot = bot

    @app_commands.command(
        name="join",
        description="Hubungkan Nadira ke voice channel kamu.",
    )
    async def join(self, interaction: discord.Interaction) -> None:
        ...
        if is_noop:
            msg = f"[INFO] Nadira sudah berada di voice channel: **{channel.name}**."
        elif is_move:
            msg = f"[BERHASIL] Memindahkan Nadira ke voice channel: **{channel.name}**."
        else:
    ...
    async def stop(self, interaction: discord.Interaction) -> None:
        ...
        if was_active:
            ...
            msg = "[INFO] Nadira sudah dalam keadaan berhenti dan tidak terhubung ke voice channel."
