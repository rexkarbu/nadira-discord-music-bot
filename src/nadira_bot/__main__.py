"""Entry point utama untuk menjalankan Nadira Discord Music Bot runtime engine."""
...
from nadira_bot.observability.logging import log_startup_info, setup_logging
from nadira_bot.settings import Settings

logger = logging.getLogger("nadira_bot.main")


async def main() -> int:
    """Fungsi utama untuk memvalidasi konfigurasi, memulai bot Nadira, dan menangani lifecycle."""
    ...
    # 3. Inisialisasi instance Bot Nadira
    ...
    try:
        ...
        logger.info("Eksekusi bot Nadira dibatalkan.")
        return 0
    except Exception:
...
if __name__ == "__main__":
    try:
        ...
        logger.info("Bot Nadira dihentikan oleh pengguna (KeyboardInterrupt).")
        sys.exit(0)
