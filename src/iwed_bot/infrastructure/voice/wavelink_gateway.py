"""Wavelink 3.5.2 Voice Gateway adapter untuk Iwed Discord Music Bot.
...
class WavelinkVoiceGateway(VoiceGateway):
    ...
    def __init__(self, bot: "IwedBot | discord.Client") -> None:
        self.bot = bot
    ...
    async def connect(
        ...
        if isinstance(channel, discord.StageChannel):
            raise UnsupportedVoiceChannel(
                "Iwed saat ini tidak mendukung Stage Channel. Gunakan Voice Channel standar."
            )
